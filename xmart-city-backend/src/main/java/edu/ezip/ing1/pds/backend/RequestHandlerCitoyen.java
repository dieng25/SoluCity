...
import edu.ezip.ing1.pds.business.server.CitoyenService;
...
public class RequestHandlerCitoyen implements Runnable {
    ...
    private final CitoyenService citoyenService = CitoyenService.getInstance();
    ...
    protected RequestHandlerCitoyen(final Socket socket,
